...
const PortfolioOverview = ({ ecosystem }: PortfolioOverviewProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Network Stats and Token Spotlight */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Latest {ecosystem.toUpperCase()} stats</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Notable tokens in the {ecosystem} ecosystem</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-2 rounded-lg bg-muted/30 hover:bg-muted transition-colors">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center">
                    <span className="text-xs font-bold text-primary">AB</span>
                  </div>
                  <div>
                    <div className="font-medium">AlphBanx</div>
                    <div className="text-xs text-muted-foreground">Native lending protocols</div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-2 rounded-lg bg-muted/30 hover:bg-muted transition-colors">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center">
                    <span className="text-xs font-bold text-blue-500">LP</span>
                  </div>
                  <div>
                    <div className="font-medium">ALPH-USDT LP</div>
                    <div className="text-xs text-muted-foreground">Liquidity provider token</div>
                  </div>
                </div>
                <div className="text-right">
                  <div>$12.32</div>
                  <div className="text-xs text-red-500">-1.8%</div>
                </div>
              </div>
            </div>
          </CardContent>
